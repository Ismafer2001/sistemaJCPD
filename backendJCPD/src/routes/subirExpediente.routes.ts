...
router.get('/files/:codigoTramite/:tipoCarpeta/:nombreArchivo', verificarToken, async (req, res) => {
    try {
...
/*router.get('/les/:codigoTramite/:tipoCarpeta/:nombreArchivo',verificarToken ,(req, res) => {
