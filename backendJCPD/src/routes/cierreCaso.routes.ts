...
router.get('/datos/:id', verificarToken,verificarCantonDenuncia, getDatosParaCierreCaso);
...
router.post('', verificarToken,verificarCantonDenuncia, postCrearCierreCaso);
