...
export async function crearPdfAudienciaPruebasNNA(res: Response, idAudienciaP: any, idUsuario:number,usuario:string,nombres:string,canton:string): Promise<void> {
  try {
